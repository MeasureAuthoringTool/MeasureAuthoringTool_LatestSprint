 ...
 */
public class ForgottenLoginIdNewView  implements ForgottenLoginIdNewPresenter.Display{
	 ...
	 */
	public ForgottenLoginIdNewView() {
		...
		emailAddressText.setTitle("Enter User ID");
