...
public class RichTextToolbar extends Composite {
	 ...
	 * 
	 * @param richtext
	 * 			Rich text area the toolbar links with
	 * @param visible
	 * 			True if you want to see the toolbar false otherwise
	 */
	public RichTextToolbar(RichTextArea richtext,Boolean visible) {
	...
	private class EventHandler implements ClickHandler,KeyUpHandler, ChangeHandler {
		public void onClick(ClickEvent event) {
			...
			}else if(event.getSource().equals(hide)){
	...
	private PushButton createShowHide(String name, String width) {
		...
		temp.addClickHandler(evHandler);
		return temp;
	}
}
